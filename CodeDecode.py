...
2024年7月22号: [8517, 8581, 8534]
2024年8月21号: [9379, 9233, 9202]
2024年9月25号: [9256, 9198, 9209]
2024年10月23号: [9348, 9576, 9411]
2024年11月29号: [9560, 9457, 9707]
2024年12月19号: [9499, 9753, 9811]
2025年1月21号: [9674, 9814, 9879]
2025年3月19号: [9868, 9941, 9896]
2025年3月26号: [10065, 10083, 9874]
2025年4月23号: [10290, 10217, 10266](有误)
2025年5月13号: [10233, 10352, 10243]
2025年5月28号: [10276, 10421, 10225]
2025年6月23号: [10422, 10373, 10127]
2025年6月25号: [10433, 10160, 10493]
2025年7月23号: [10359, 10430, 10328]
2025年8月20号: [10729, 10745, 10617]
2025年9月24号: [10808, 10805, 10626]
2025年10月4号: [10735, 10670, 10838]
2025年10月22号: [10967, 10992, 10874]
2025年11月19号: [11078, 11091, 10943]
2025年12月17号: [11204, 11242, 11359]
2026年1月14号: [11191, 11299, 11437]
'''
    ...
    while index < len(line):
        ...
        if line[index] != ' ':
            ...
            if not isRegular:  # 是普通字符串
                ...
                word += line[index] + line[index + 1]  # 先写入正斜杠和一个下一个字符
                index += 2
                while index < len(line):
                    # 以 '/,' 结束
...
# 输出三行字典的长度, 方便 debug
print('第一行字典首个变量名: $' + NAME[0][0] + ' , 长度: ' + str(len(DATA[0])))
print('第二行字典首个变量名: $' + NAME[1][0] + ' , 长度: ' + str(len(DATA[1])))
print('第三行字典首个变量名: $' + NAME[2][0] + ' , 长度: ' + str(len(DATA[2])))
